...
class WithdrawalUsdcSolana extends StatefulWidget {
  const WithdrawalUsdcSolana({
    super.key,
  });

  @override
  State<WithdrawalUsdcSolana> createState() => _WithdrawalUsdcSolanaState();
}

class _WithdrawalUsdcSolanaState extends State<WithdrawalUsdcSolana> {
  List<WalletUSDCAddress> walletAddresses = [];
  ...
  void initState() {
    ...
    context.read<WalletBloc>().add(GetWalletAddressUSDCEvent());
    ...
    return BlocConsumer<WalletBloc, WalletState>(
      listener: (context, state) {
        if (state is WalletAddressUSDC) {
          walletAddresses = state.walletAdrressesUSDC;
          print('vvhbjkljkllklkkl${walletAddresses.length}');
        }
        ...
        //       extra: {'isEnterOtp': false, 'isFiatWithdrawal': false});
        // }
      },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _customTextfield(context,
                          title: 'USDC', controller: amountController),
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            hint:
                                Text('${walletAddresses.length}Select Network'),
