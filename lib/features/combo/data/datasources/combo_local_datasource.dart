...
abstract class ComboLocalDatasource {
  Future<File?> selectImage({required ImageSource imageSource});
}

class ComboLocalDatasourceImpl implements ComboLocalDatasource {
  ComboLocalDatasourceImpl({required this.appPreferenceService});
