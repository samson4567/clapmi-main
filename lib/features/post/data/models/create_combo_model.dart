import 'package:clapmi/features/post/domain/entities/singlelive_create_combo_enitty.dart';
...
class SingleLiveCreateModel extends SingleLiveCreateEntity {
  const SingleLiveCreateModel({
    required super.type,
  ...
  SingleLiveCreateEntity toEntity() => this;
}
